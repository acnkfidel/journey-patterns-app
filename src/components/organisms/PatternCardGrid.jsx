...
const PATTERNS = [
  {
    ...
    color: 'violet',
    routes: ['/pattern1/guest', '/pattern1/member'],
    complexity: 'Low',
    description:
      'The page reads config.sections and maps over it. A sectionRegistry resolves string keys to React components. No if/else inside the page — the config is the source of truth.',
    icon: '⚙️',
  },
  {
    number: 2,
    name: 'Slot / Render Props',
    color: 'sky',
    routes: ['/pattern2/guest', '/pattern2/member'],
    complexity: 'Medium',
    description:
      'A shell accepts named slot props (headerSlot, formSlot, summarySlot). Each journey page injects its own components. The shell stays dumb and reusable.',
    icon: '🔌',
  },
  {
    number: 3,
    name: 'Context / Feature Flags',
    color: 'amber',
    routes: ['/pattern3/guest', '/pattern3/member', '/pattern3/admin'],
    complexity: 'Medium',
    description:
      'Each section independently reads a feature flag from JourneyContext and self-hides. The parent page renders all sections unconditionally — zero journey logic at page level.',
    icon: '🚩',
  },
  {
    number: 4,
    name: 'HOC / Factory',
    color: 'emerald',
    routes: ['/pattern4/guest', '/pattern4/member', '/pattern4/admin'],
    complexity: 'Medium-High',
    description:
      'A Higher-Order Component wraps BaseDashboard and injects the journey config as a prop. BaseDashboard is pure — it never imports journeyConfigs. Each variant is one line.',
    icon: '🏭',
  },
];
