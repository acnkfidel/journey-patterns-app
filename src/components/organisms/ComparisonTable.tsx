...
const ROWS: TableRow[] = [
  { pattern: '1. Config-Driven', color: 'violet', complexity: 'Low',
  ...
  { pattern: '2. Slot Props', color: 'sky', complexity: 'Medium',
  ...
  { pattern: '3. Context Flags', color: 'amber', complexity: 'Medium',
  ...
  { pattern: '4. HOC / Factory', color: 'emerald', complexity: 'Medium-High',
...
const HEADERS = ['Pattern', 'Complexity', 'Best For', 'Journey Isolation', 'Scalability'];
