import type { HiddenItem } from '../../types/journey';

interface HiddenItemsPanelProps {
  items: HiddenItem[];
}

export default function HiddenItemsPanel({ items }: HiddenItemsPanelProps) {
  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="font-semibold text-amber-800 text-sm">What&apos;s Hidden &amp; Why</span>
