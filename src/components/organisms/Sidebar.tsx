...
import type { DotColor } from '../atoms/Dot';
...
const NAV_GROUPS: NavGroup[] = [
  {
    id: 'home',
    label: null,
    items: [{ label: 'Overview', path: '/', end: true }],
  },
  {
    id: 'pattern1',
    label: 'Pattern 1', sublabel: 'Config-Driven',
    color: 'text-violet-400', dot: 'violet',
    items: [
  ...
  {
    id: 'pattern2',
    label: 'Pattern 2', sublabel: 'Slot / Render Props',
    color: 'text-sky-400', dot: 'sky',
    items: [
  ...
  {
    id: 'pattern3',
    label: 'Pattern 3', sublabel: 'Context Flags',
    color: 'text-amber-400', dot: 'amber',
    items: [
  ...
  {
    id: 'pattern4',
    label: 'Pattern 4', sublabel: 'HOC / Factory',
    color: 'text-emerald-400', dot: 'emerald',
    items: [
    ...
    <aside className="w-64 flex-shrink-0 bg-gray-900 flex flex-col overflow-hidden border-r border-gray-800">
      ...
      <div className="px-4 py-4 border-t border-gray-800">
        {activeJourney ? (
          ...
          <div className="px-3 py-2 text-xs text-gray-600 text-center">Select a pattern to explore</div>
        )}
      </div>
    </aside>
  );
