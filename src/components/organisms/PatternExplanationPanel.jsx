...
export default function PatternExplanationPanel({ patternNumber, explanation }) {
  const [open, setOpen] = useState(false);
  const accentBg = ACCENT_COLORS[patternNumber] || 'bg-indigo-600';
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2.5">
          <div className={`w-6 h-6 rounded-md ${accentBg} flex items-center justify-center flex-shrink-0`}>
