...
const FALLBACK: WidgetMeta = { icon: '📌', color: 'border-gray-200 bg-gray-50 text-gray-700', hover: '' };

export default function WidgetCard({ name, active = true }: WidgetCardProps) {
